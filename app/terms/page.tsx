    ...
    <LegalLayout eyebrow="Legal" title="Terms of Service">
      ...
      <section id="what-it-is">
        ...
        <p>
          ...
          "hallucinate" facts. Scores and feedback are illustrative estimates only — they are
          generated by AI models that may make mistakes or miss nuance. The scoring methodology is
          not based on any scientifically validated framework, peer-reviewed research, or
          standardized assessment methodology. Scores are generated entirely by artificial
          intelligence and do not represent an objective or certified measure of your interview
          ability, technical competence, or employability. The Service does not
          guarantee that you will perform well in any real interview, receive a job offer, or
          achieve any particular outcome. Interview success depends on many factors beyond the scope
          of any practice tool. You use all output at your own risk and are solely responsible for
      ...
      <section id="disclaimer">
        ...
        <p>
          This Service uses artificial intelligence to generate feedback and scoring. AI is
          imperfect — it may misinterpret answers, overlook strengths, or provide feedback that does
          not reflect how a real interviewer would evaluate you. We make no representation or
          warranty that using the Service will improve your interview skills, lead to job offers, or
          produce any specific outcome. Practice with the Service does not guarantee a successful
          interview.
        </p>
        <p>
