...
export const PLANS: Plan[] = [
  {
    ...
    blurb: 'Kick the tires and feel the loop.',
    cta: 'Start free',
    featured: false,
    perks: [
  ...
  },
  {
    ...
    price: '$29',
    cadence: 'per month',
    blurb: 'Everything you need while you are actively in the loop.',
    cta: 'Go Pro',
    featured: true,
    perks: [
...
export const FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: 'Yes. Pro is billed monthly and you can cancel whenever you like — no contracts, no penalty.',
  },
];
